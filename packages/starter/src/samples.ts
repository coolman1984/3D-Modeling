import type { ItemInstance, Project } from '@space-planner/core';
import { referenceVehicleDepot } from './depot.js';
import { FORKLIFT, cm, forklift, kg, loadedContainer, m, materialDefinition, pallet, palletBlock, region, warehouseSite, type MaterialSpec } from './sampleKit.js';
import type { RackSpec } from './warehouse.js';
...
export const NILE_GATE_MATERIALS = MATERIAL_SPECS.map(materialDefinition);
